...
public:
    ...
    void TestSolvingFibre() //throw(Exception)
    {
        ...
        out_stream p_file_grad = output_file_handler.OpenOutputFile("hsb16_tesel_4_grad_longi.txt");
        out_stream p_file_grad_mag = output_file_handler.OpenOutputFile("hsb16_tesel_4_mag_grad_longi.txt");
